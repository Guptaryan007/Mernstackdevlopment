                ...
                <div className="space-y-4">
                     ...
                     <div className="flex items-center gap-2">
                      <input
                        ...
                        value={"partner"}
                         onChange={handleChange}
                      />
                      <label htmlFor="partner">Delievery Partner</label>
                    </div>
                     <div className="flex items-center gap-2">
                      <input
                        type="radio"
                  ...
                  <div>
                    <input
                      ...
                      required
                      disabled={isLoading}
                      className="w-full h-fit px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 transition cursor-not-allowed  disabled:bg-gray-200"
                    />
                  ...
                  <input
                    ...
                    required
                    disabled={isLoading}
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 transition cursor-not-allowed  disabled:bg-gray-200"
                  />
                  <input
                    type="password"
                    name="password"
